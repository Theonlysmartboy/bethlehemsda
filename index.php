...
<html lang="en">
  <head>
    <title>Bethlehem SDA Kisumu</title>
    <meta charset="utf-8">
    ...
    <header role="banner">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <a class="navbar-brand absolute" href="index.php"><img src="images/logo.gif" alt="" style="width: 100px; height: 100px;"/> <span class="text-primary">Bethlehem Sda</span>  </a>
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item" href="ministry.php">Outreach Ministry</a>
                  <a class="dropdown-item" href="ministry.php">Men's Ministry</a>
                  <a class="dropdown-item" href="ministry.php">Women's Ministry</a>
                  <a class="dropdown-item" href="ministry.php">Children's Ministry</a>
                  <a class="dropdown-item" href="ministry.php">Youth Ministry</a>
                </div>
